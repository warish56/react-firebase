            ...
            <div className="container">
                <div className="row justify-content-center align-item-center">
                    <div className="col-xl-6 p-2 m-auto">
                        ...
                        <div className="form-group">
                            <button type="button" onClick={()=>this.props.login(this.state.email,this.state.password,this.props)} className="btn btn-success btn-block">Login</button>
                        </div>
...
let mapDispatchStateToProps = dispatch =>{
    return{
        login: (email,password,props) => dispatch(auth.Login(email,password,props))
    }
    };
